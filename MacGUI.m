function varargout = MacGUI(varargin)
...
% Last Modified by GUIDE v2.5 10-Jan-2018 11:38:06

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @MacGUI_OpeningFcn, ...
                   'gui_OutputFcn',  @MacGUI_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
function MacGUI_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = MacGUI_OutputFcn(hObject, eventdata, handles)
