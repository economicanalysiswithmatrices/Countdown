function varargout = WindowsGUI(varargin)
...
% Last Modified by GUIDE v2.5 10-Jan-2018 11:35:53

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @WindowsGUI_OpeningFcn, ...
                   'gui_OutputFcn',  @WindowsGUI_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
function WindowsGUI_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = WindowsGUI_OutputFcn(hObject, eventdata, handles)
